console.log("family.js has been loaded...");
console.log("Loading Pictures...");
var gallery = firebase.database().ref('/familyPics');
...
$('#picturePopupModal').on('show.bs.modal',function(event){
    ...
    var modal = $(this)
    var x = "/familyPics/pic0"+ img_number_string;
    console.log(x);
...
function likePicture(x){
    ...
    var picRef = "/familyPics/pic0"+x;
    var picture = firebase.database().ref(picRef);
    var pics = firebase.database().ref('/familyPics');
