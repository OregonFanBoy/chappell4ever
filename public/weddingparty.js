console.log("weddingparty.js has been loaded...");
console.log("Loading Pictures...");
var gallery = firebase.database().ref('/weddingpartyPics');
...
$('#picturePopupModal').on('show.bs.modal',function(event){
    ...
    var modal = $(this)
    var x = "/weddingpartyPics/pic0"+ img_number_string;
    console.log(x);
...
function getLikes(x){
    ...
    var picRef = "/weddingpartyPics/pic0"+x;
...
function likePicture(x){
    ...
    var picRef = "/weddingpartyPics/pic0"+x;
    var picture = firebase.database().ref(picRef);
    var pics = firebase.database().ref('/weddingpartyPics');
