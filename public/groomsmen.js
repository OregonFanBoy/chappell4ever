console.log("groomsmen.js has been loaded...");
console.log("Loading Pictures...");
var gallery = firebase.database().ref('/groomsmenPics');
...
$('#picturePopupModal').on('show.bs.modal',function(event){
    ...
    var modal = $(this)
    var x = "/groomsmenPics/pic0"+ img_number_string;
    console.log(x);
...
function getLikes(x){
    ...
    var picRef = "/groomsmenPics/pic0"+x;
...
function likePicture(x){
    ...
    var picRef = "/groomsmenPics/pic0"+x;
    var picture = firebase.database().ref(picRef);
    var pics = firebase.database().ref('/groomsmenPics');
